...
```
source/tests/
├── test_{module}.py           # Unit and integration test suites
├── demo_{module}.py           # Demonstration scripts with live examples
├── sample_plots/              # Generated plots organized by module
│   ├── demo_{module}/         # Plots generated by demo scripts
│   └── {other_plots}/         # Standalone example plots
├── validation_blueprint*.py   # Core validation systems
├── enhanced_validation*.py    # Advanced validation tools
...
def main():
    ...
    print("🎉 Demo Complete! Generated X plots...")
