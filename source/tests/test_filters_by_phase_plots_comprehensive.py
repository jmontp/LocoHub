...
Tests the unified filters by phase plotting function with:
1. Basic functionality (validation ranges only)
2. Data overlay functionality with step data
3. Step color classification and visualization (red, pink, gray)
4. Both kinematic and kinetic modes
5. Error handling and edge cases
6. Integration with real validation data
"""
