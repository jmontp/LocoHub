...
<p class="feature-source">Coverage computed from `converted_datasets/umich_2024_knee_exo_phase.parquet`.</p>
...
- `converted_datasets/umich_2024_knee_exo_phase.parquet` — Phase-normalized dataset
- [Validation report](#validation)
- Conversion script in `contributor_tools/conversion_scripts/um24k/`

---

*Generated by Dataset Submission Tool on 2025-12-20 16:52*
