...
Walking dataset with 50 subjects (ages 6-72) including normal walking, toe walking,
heel walking, and stair ascent/descent. Data processed through AddBiomechanics pipeline.
...
<p class="feature-source">Coverage computed from `converted_datasets/Tiziana2019_phase.parquet`.</p>
...
- **Validation Ranges**: [Download validation ranges](./ti19_validation_ranges.yaml) (source: contributor_tools/validation_ranges/default_ranges.yaml)
- **Detailed Report**: [View validation report](#validation)

## Citation
Lencioni T et al. (2019) Human kinematic and kinetic data during gait.
Nature Scientific Data. DOI: 10.1038/s41597-019-0323-z
...
- `converted_datasets/Tiziana2019_phase.parquet` — Phase-normalized dataset
- [Validation report](#validation)
- Conversion script in `contributor_tools/conversion_scripts/ti19/`
