...
Modified walking biomechanics dataset with various gait pattern modifications.
...
- **Tasks Included**: Dynamic Walk

#### Task Catalog

| Task | Task ID | Task Info |
|------|---------|-----------|
| dynamic_walk | modified_walk | variant:modified,original_task:baseline |
|   |   | variant:modified,original_task:fpa |
|   |   | variant:modified,original_task:step_width |
|   |   | variant:modified,original_task:trunk_sway |
...
<p class="feature-source">Coverage computed from `converted_datasets/Tan2022_phase.parquet`.</p>

#### Ground Reaction Forces

| Feature | Dynamic Walk |
|---|---|
...
- **Validation Ranges**: [Download validation ranges](./ta22_validation_ranges.yaml) (source: contributor_tools/validation_ranges/default_ranges.yaml)
- **Detailed Report**: [View validation report](#validation)

## Citation
Tan et al. (2022) Modified walking biomechanics study.
...
- `converted_datasets/Tan2022_phase.parquet` — Phase-normalized dataset
- [Validation report](#validation)
- Conversion script in `contributor_tools/conversion_scripts/ta22/`

---

*Generated by Dataset Submission Tool on 2025-12-21 18:54*
