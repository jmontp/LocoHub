...
Walking and running dataset from muscle redundancy studies. Data processed through
...
|------|---------|-----------|
| level_walking | level | original_task:Gait_1 |
|   |   | original_task:Gait_10 |
|   |   | original_task:Gait_7 |
|   |   | original_task:Gait_8 |
|   |   | original_task:Gait_9 |
|   |   | original_task:STS_1 |
|   |   | original_task:STS_2 |
|   |   | original_task:STS_5 |
...
<p class="feature-source">Coverage computed from `converted_datasets/Falisse2016_phase.parquet`.</p>
...
- **Validation Ranges**: [Download validation ranges](./fa16_validation_ranges.yaml) (source: contributor_tools/validation_ranges/default_ranges.yaml)
- **Detailed Report**: [View validation report](#validation)

## Citation
Falisse A et al. (2016) Muscle redundancy study. Ann Biomed Eng.
...
- `converted_datasets/Falisse2016_phase.parquet` — Phase-normalized dataset
- [Validation report](#validation)
- Conversion script in `contributor_tools/conversion_scripts/fa16/`
