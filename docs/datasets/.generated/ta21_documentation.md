...
Modified running biomechanics dataset with various running pattern modifications.
...
|------|---------|-----------|
| run | modified_run | variant:modified,original_task:mini_SI_24 |
|   |   | variant:modified,original_task:mini_SI_28 |
|   |   | variant:modified,original_task:mini_SR_24 |
|   |   | variant:modified,original_task:mini_SR_28 |
|   |   | variant:modified,original_task:mini_baseline_24 |
|   |   | variant:modified,original_task:mini_baseline_28 |
|   |   | variant:modified,original_task:nike_SI_24 |
|   |   | variant:modified,original_task:nike_SI_28 |
|   |   | variant:modified,original_task:nike_SR_24 |
|   |   | variant:modified,original_task:nike_SR_28 |
|   |   | variant:modified,original_task:nike_baseline_24 |
|   |   | variant:modified,original_task:nike_baseline_28 |
...
<p class="feature-source">Coverage computed from `converted_datasets/Tan2021_phase.parquet`.</p>
...
- **Validation Ranges**: [Download validation ranges](./ta21_validation_ranges.yaml) (source: contributor_tools/validation_ranges/default_ranges.yaml)
- **Detailed Report**: [View validation report](#validation)

## Citation
Tan et al. (2021) Modified running biomechanics study.
...
- `converted_datasets/Tan2021_phase.parquet` — Phase-normalized dataset
- [Validation report](#validation)
- Conversion script in `contributor_tools/conversion_scripts/ta21/`

---

*Generated by Dataset Submission Tool on 2025-12-21 18:53*
